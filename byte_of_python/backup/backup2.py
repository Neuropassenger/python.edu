'''
Программа для резервного копирования. Версия 2.0
...
P.S.
Странно, но программа отказалась работать при использовании 
относительных путей в именах каталогов и файлов. Первая версия
работала исправно.
'''
